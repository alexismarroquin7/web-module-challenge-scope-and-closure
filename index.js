...
/*Task 1: counterMaker()
  ...
  counter1 is preferable when you want to create private variables.
...
function scoreboard(getInningScoreCB, inningCB, expectedInnings){
  /* CODE HERE */
  let results = [];
  let homeScore = 0;
  let awayScore = 0;
  for(let i = 0; i < expectedInnings; i++){
